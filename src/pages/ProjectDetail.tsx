...
const ProjectDetail = () => {
  ...
  useEffect(() => {
    if (project) {
      ...
      const ogImage = project.hero_image_url || 'https://digitalinvest.com/og-image.jpg';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 pb-16">
        ...
        {/* AGRON Additional Presentations & Video */}
        {project.slug === 'agron' && (
          <>
            <section className="mb-16">
              <h2 className="text-3xl font-bold mb-8 text-foreground">Additional Presentations</h2>
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <Card key={doc.title} className="border border-border/50 bg-card flex flex-col">
                    <CardContent className="pt-6 flex-1 flex flex-col">
                      <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
                        <FileText className="w-6 h-6 text-primary" />
                      </div>
                      <h3 className="text-lg font-semibold mb-2 text-foreground">{doc.title}</h3>
                      ...
                      <div className="flex gap-2 flex-wrap">
                        ...
                        <a href={doc.url} download={doc.file}>
                          <Button size="sm" className="gap-2"><Download className="w-4 h-4" /> PDF</Button>
                        </a>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold mb-8 text-foreground">Video Overview</h2>
