...
const AdamasMaterialsOverview = () => {
  ...
  useEffect(() => {
    ...
    updateMetaTags({
      ...
      ogImage: 'https://digitalinvest.com/adamas-og-image.jpg',
      ogType: 'website',
  ...
  return (
    <div className="min-h-screen bg-[hsl(220,14%,96%)] dark:bg-background">
      ...
      <section
        ref={heroRef}
        className="relative pt-20 pb-28 overflow-hidden bg-[hsl(220,14%,97%)] dark:bg-[hsl(220,20%,6%)]"
        onMouseMove={handleMouseMove}
      >
      ...
      <div className="h-16 bg-[hsl(220,14%,96%)] dark:bg-background" />
