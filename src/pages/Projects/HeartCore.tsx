  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <OptimizedImage
          src={heartcoreHero}
          alt="Heart - Heart Rate Variability Platform"
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="max-w-3xl animate-fade-in" style={{ animationDelay: '0.1s', animationFillMode: 'backwards' }}>
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-foreground">Heart</h1>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="mb-16">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Heart focuses on patterns rather than diagnoses, tracking HRV, heart rate trends, and their correlations with stress and sleep. The platform provides early indicators of overload or imbalance through daily recommendations based on personalized patterns.
            </p>
          </div>
          ...
          <div className="bg-muted/20 border-l-4 border-primary p-6 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Heart is an informational tool for tracking cardiovascular patterns. It is not a medical device and does not diagnose, treat, or prevent any medical condition. All insights are for informational purposes only. Consult qualified healthcare professionals for medical advice.
            </p>
          </div>
        </div>
      </section>
