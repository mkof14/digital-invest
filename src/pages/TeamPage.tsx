        ...
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="block text-foreground mb-2">{t('team.title1')}</span>
              <span className="block gradient-purple-animated">{t('team.title2')}</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">{t('team.subtitle')}</p>
          </div>

          <section className="mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">{t('team.executiveLeadership')}</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
              ...
              <Card className="hover:-translate-y-1 transition-all duration-300 border border-border/50 bg-card hover:shadow-elevated">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3"><Building2 className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">Founded 5+ successful technology companies</span></div>
                    <div className="flex items-center space-x-3"><Linkedin className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">Ph.D. in Information Technology</span></div>
                  </div>
              ...
              <Card className="hover:-translate-y-1 transition-all duration-300 border border-border/50 bg-card hover:shadow-elevated">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3"><CheckCircle2 className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">Best Defense Enterprise Designer Award</span></div>
                    <div className="flex items-center space-x-3"><Building2 className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">20+ years in engineering leadership</span></div>
                    <div className="flex items-center space-x-3"><Linkedin className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">Master's in Electrical Engineering</span></div>
                  </div>
                  <div className="bg-primary/5 rounded-lg p-4 border border-primary/20">
                    <h4 className="font-semibold text-primary mb-2">{t('team.technicalExpertise')}</h4>
                    <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <Card className="hover:-translate-y-1 transition-all duration-300 border border-border/50 bg-card hover:shadow-elevated">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3"><CheckCircle2 className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">Leading Female Attorney in Tech Law</span></div>
                    <div className="flex items-center space-x-3"><Building2 className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">Founded legal practice in 2003</span></div>
                    <div className="flex items-center space-x-3"><Linkedin className="w-5 h-5 text-secondary" /><span className="text-sm font-medium">NY and NJ State Bars member</span></div>
                  </div>
                  <div className="bg-primary/5 rounded-lg p-4 border border-primary/20">
                    <h4 className="font-semibold text-primary mb-2">{t('team.legalSpecializations')}</h4>
                    <ul className="text-sm text-muted-foreground space-y-1">
